...
import { Copyright, Facebook, Instagram, Mail, MoveRight, Twitter } from "lucide-react";
  ...
  return (
    <div className="footerContainer pt-14 border-t mt-10  md:px-14">
      <div className="footer flex flex-col justify-center items-center md:items-center md:flex-row gap-10 md:gap-4 w-full">
        <div className="leftBigLogoContainer flex flex-col w-3/4 md:w-1/3 gap-4">
          <Image
            src={BigLogo}
            alt="Logo"
            width={200}
        ...
        <div className="middleLinksContainer w-3/4 md:w-1/3 flex flex-col">
          <h1 className="font-medium text-2xl underline  underline-offset-2 mb-4">Links</h1>
          <div className="links flex flex-col justify-center gap-3">
            <Link href={""} className="text-xl font-medium hover:underline" > Home </Link>
            <Link href={""} className="text-xl font-medium hover:underline" >Categories</Link>
            <Link href={""} className="text-xl font-medium hover:underline" >Brands</Link>
            <Link href={""} className="text-xl font-medium hover:underline" >Accessories</Link>
            <Link href={""} className="text-xl font-medium hover:underline" >Contact Us</Link>
        ...
        <div className="rightNewsLetterContainter w-3/4 md:w-1/3 flex flex-col gap-4">
          <div className="socialMedia">
            <h1 className="font-bold  text-xl">Get in touch</h1>
            <div className="socialIcons flex gap-4 items-center mt-2">
              <Link href={""}>
                <Instagram />
              </Link>
              <Link href={""}>
